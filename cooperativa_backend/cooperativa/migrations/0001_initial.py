...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(help_text='Nombre descriptivo de la campaña', max_length=200, unique=True, validators=[django.core.validators.RegexValidator(message='Nombre solo puede contener letras, números, espacios, guiones, puntos y barras', regex='^[a-zA-ZÀ-ÿ0-9\\s\\-\\.\\/]+$')])),
                ('fecha_inicio', models.DateField(help_text='Fecha de inicio de la campaña')),
                ('fecha_fin', models.DateField(help_text='Fecha programada de finalización de la campaña')),
                ('meta_produccion', models.DecimalField(decimal_places=2, help_text='Meta de producción total de la campaña (en kg o toneladas)', max_digits=12, validators=[django.core.validators.MinValueValidator(0, message='La meta de producción no puede ser negativa')])),
                ('unidad_meta', models.CharField(default='kg', help_text='Unidad de medida de la meta (kg, toneladas, quintales, etc.)', max_length=20)),
                ('estado', models.CharField(choices=[('PLANIFICADA', 'Planificada'), ('EN_CURSO', 'En Curso'), ('FINALIZADA', 'Finalizada'), ('CANCELADA', 'Cancelada')], default='PLANIFICADA', help_text='Estado actual de la campaña', max_length=20)),
                ('descripcion', models.TextField(blank=True, help_text='Descripción detallada de los objetivos y características de la campaña', null=True)),
                ('presupuesto', models.DecimalField(blank=True, decimal_places=2, help_text='Presupuesto asignado a la campaña', max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(0, message='El presupuesto no puede ser negativo')])),
                ('creado_en', models.DateTimeField(default=django.utils.timezone.now)),
                ('actualizado_en', models.DateTimeField(auto_now=True)),
                ('responsable', models.ForeignKey(blank=True, help_text='Usuario responsable de coordinar la campaña', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='campañas_responsables', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_asignacion', models.DateField(default=django.utils.timezone.now, help_text='Fecha en que la parcela fue asignada a la campaña')),
                ('superficie_comprometida', models.DecimalField(blank=True, decimal_places=2, help_text='Superficie de la parcela comprometida para esta campaña (en hectáreas)', max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(0.01, message='La superficie debe ser mayor a 0')])),
                ('cultivo_planificado', models.CharField(blank=True, help_text='Cultivo planificado para esta parcela en la campaña', max_length=100, null=True)),
                ...
                ('parcela', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campañas', to='cooperativa.parcela')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rol', models.CharField(choices=[('COORDINADOR', 'Coordinador'), ('PRODUCTOR', 'Productor'), ('TECNICO', 'Técnico Agrícola'), ('SUPERVISOR', 'Supervisor')], default='PRODUCTOR', help_text='Rol del socio en la campaña', max_length=20)),
                ('fecha_asignacion', models.DateField(default=django.utils.timezone.now, help_text='Fecha en que el socio fue asignado a la campaña')),
                ...
                ('socio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campañas_participadas', to='cooperativa.socio')),
            ],
            options={
